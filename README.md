...
Inside the `simulations` subdirectory, you will find the following: 
  ...
  - `TableS2_SimSetup.R`: Simulations with outcome misclassification and binary error-prone covariate, intended to compare performance of the fully-parametric MLE and proposed SMLE under complex specification of $P(X|X^*)$
