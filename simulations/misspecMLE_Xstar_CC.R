...
for(s in 1:num_sims)
{
  ...
  write.csv(rbind(smle_res, tang_res, naive_res, complete_res, ht_res), paste0("delta", delta3, "_", N, "_pv", 100*pv,"_seed", sim_seed, "_", ifelse(audit == "SRS", "SRS", "CC"), ".csv"), row.names = FALSE)
}
